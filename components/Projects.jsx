    ...
    return (
        <a href={link} className="bg-neutral-50 w-full block border-2 border-black box-shadow-md-black">
            <div className="relative overflow-hidden">
                ...
                <h1 className="absolute top-10 left-10 font-bold text-xl bg-purple-500 px-2">
                    {title}
                </h1>
                <h1 className="dark:text-neutral-800 absolute bottom-10 left-10 font-bold text-xl">
