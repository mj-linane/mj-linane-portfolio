                ...
                <div className="space-x-4 flex flex-row items-center">
                    ...
                    <div className="space-x-4 flex flex-row items-center">
                        <a href={userData.socialLinks.github}
                           className="text-base font-normal text-neutral-600 dark:text-neutral-300"
                        >
                            {/*TODO: swap the remaining lines with the svg icon*/}
                            <div className="my-4">&rarr;</div>
                            <p className="text-lg-text-neutral-500 font-mono relative overflow-hidden dark:text-neutral-300">
                                <div
                                    className="absolute h-0 5 w-full bg-neutral-400 bottom-0 transform -translate-x-24 group-hover:translate-x-0 transition duration-300">
                                    GitHub
                                </div>
                            </p>
                        </a>
