...
export default function Experience() {
    return (
        <section className="bg-neutral-50 dark:bg-neutral-800">
            <div
                className="max-w-6xl mx-auto h-48">
            ...
            {/*</div>*/}
            <div
                className="bg-neutral-200 dark:bg-neutral-900 -mt-4 py-20 lg:py-40">
                <div
                    className="grid grid-cols-1 dark:bg-neutral-900 max-w-xl mx-auto pt-20">
                    {/* Experience Card*/}
                            ...
                            {index === userData.experience.length - 1 ? null : (
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="w-4 h-4 bg-purple-500 rounded-full relative z-10 animate-ping">
                                        </div>
                                    </div>
                                    <div
                                        className="w-1 h-24 bg-purple-500 rounded-full -mt-2 z-10">
                                    </div>
                                </div>
                            )}
                        </>
...
const ExperienceCard = ({title, description, year, company, companyLink}) => {
    return (
        <div
            className="relative border-4 border-black box-shadow-md-black p-4 bg-neutral-50 dark:bg-neutral-800 z-10 mx-4">
